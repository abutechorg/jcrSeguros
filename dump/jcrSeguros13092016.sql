...
INSERT INTO `menu_aplicacion` VALUES (1,1,'Usuarios','fa fa-user','JCR Seguros',1),(2,1,'Polizas','fa fa-file-powerpoint-o','JCR Seguros',2),(3,1,'Vehiculos','fa fa-car','JCR Seguros',3),(4,1,'Siniestros','fa fa-warning','JCR Seguros',4),(5,1,'Coberturas','fa fa-credit-card','JCR Seguros',5),(6,1,'Aseguradoras','fa fa-industry','JCR Seguros',6),(7,1,'Opciones Administrativas','fa fa-cogs','JCR Seguros',7);
...
--
-- Table structure for table `poliza_beneficiario`
--

DROP TABLE IF EXISTS `poliza_beneficiario`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `poliza_beneficiario` (
  `poliza_id` int(11) NOT NULL,
  `usuario_id` int(11) NOT NULL,
  PRIMARY KEY (`poliza_id`,`usuario_id`),
  KEY `usuario_id_benef_fk_idx` (`usuario_id`),
  CONSTRAINT `poliza_id_benef_fk` FOREIGN KEY (`poliza_id`) REFERENCES `poliza` (`poliza_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `usuario_id_benef_fk` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`usuario_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `poliza_beneficiario`
--

LOCK TABLES `poliza_beneficiario` WRITE;
/*!40000 ALTER TABLE `poliza_beneficiario` DISABLE KEYS */;
INSERT INTO `poliza_beneficiario` VALUES (3,1),(5,1),(1,5),(3,5);
/*!40000 ALTER TABLE `poliza_beneficiario` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `siniestro` VALUES (3,1,1,'123456789','20/01/1983',957,1,1,'20/01/2016','01-01-2016',1);
...
INSERT INTO `usuarios` VALUES (1,'Yajaira','Vera','1573934','21/03/1984','yaja.vera21@gmail.com','Los Teques',2,'',1),(2,'Vladimir','Fernandez','16368619','21/03/1984','vladimir.fernandez21@gmail.com','Los Teques',4,'12345',1),(5,'Luis','Fernandez','14368619','21/03/1984','luis.fernandez@gmail.com','Los Teques',2,'',1),(8,'Gabriela','Wilches','37474444','22/05/1981','gwilches@gmail.com','Caracas',8,NULL,1),(9,'Lenin','Fernandez','3639363','02/03/2016','mao123@gmail.com','caracas,prados de este',1,NULL,1),(11,'Eduardo','Luttinger','12477393','13/05/1982','eluttinger@gmail.com','San antonio de los altos',4,'12345',1);
...
-- Dump completed on 2016-09-13 19:00:17
