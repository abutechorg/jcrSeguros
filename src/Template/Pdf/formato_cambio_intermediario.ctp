        ...
        <div class="col-lg-12">
            <div class="content">
                ...
                <p style="text-align:justify;line-height:50px;margin-right: 5em;margin-left: 2em;">
                    ...
                    decidido nombrar como mi intermediario de seguros al ciudadano <?=$data[0]['agente']?> código <?=$data[0]['cod_agente']?>, en aras
                    de que sea, en adelante, quien me represente con todo lo relacionado a mi póliza de seguros.
                </p>
                <br>
