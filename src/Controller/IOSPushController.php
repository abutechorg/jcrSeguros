...
define("IOS_SERVICE_CERTIFICATE", "/var/www/attendanceCloud.com/html/reaxiumCloud/develop/reaxiumCert.pem");
define("IOS_SERVICE_CERTIFICATE_PRODUCTION", "/var/www/attendanceCloud.com/html/reaxiumCloud/reaxiumCert.pem");
...
class IOSPushController extends AppController
{
     ...
     * @var array
     */
    private static $apnsDataProduction = array('certificate' => IOS_SERVICE_CERTIFICATE_PRODUCTION, 'ssl' => IOS_APNS);
