...
class UsersController extends ReaxiumAPIController
{
        ...
        if (parent::validReaxiumJsonHeader($jsonObject)) {
            ...
            try {
                if (isset($jsonObject['ReaxiumParameters']["page"])) {
                    ...
                    $businessIdMaster = !isset($jsonObject['ReaxiumParameters']["business_master_id"]) ? null : $jsonObject['ReaxiumParameters']["business_master_id"];
                    ...
                    if (isset($userTypeId) && $userTypeId == CALL_CENTER) {
                        $andCondition = array(
                            'Users.business_master_id' => $businessIdMaster,
                            'OR' => array(
                                array('Users.status_id' => 1),
                                array('Users.status_id' => 2)
                            ),
                            array('NOT' => array('Users.user_type_id' => 1)));
                    } elseif (isset($userTypeId) && $userTypeId == BUSINESS_CLIENT) {
        ...
        if (parent::validReaxiumJsonHeader($jsonObject)) {
            try {
                if (isset($jsonObject['ReaxiumParameters']["Users"]["filter"])) {
                    ...
                    $businessId = !isset($jsonObject['ReaxiumParameters']["Users"]["business_id"]) ? null : $jsonObject['ReaxiumParameters']["Users"]["business_id"];
                    $businessIdMaster = !isset($jsonObject['ReaxiumParameters']["Users"]["business_master_id"]) ? null : $jsonObject['ReaxiumParameters']["Users"]["business_master_id"];
                    ...
                    if (isset($userTypeId) && $userTypeId == CALL_CENTER) {
                        ...
                        $andCondition = array('Users.business_master_id' => $businessIdMaster, 'Users.status_id' => 1, array('NOT' => array('Users.user_type_id' => 1)));

                    } elseif (isset($userTypeId) && $userTypeId == BUSINESS_CLIENT) {

                        $andCondition = isset($business_id) ? array('Users.status_id' => 1, 'Users.business_id' => $businessId) : array('Users.status_id' => 1);

                    } else {

                        $andCondition = array('Users.business_master_id' => $businessIdMaster, 'Users.status_id' => 1);
    ...
    public function saveUserFromDevice()
    {
        ...
        $userBusinessMasterID = !isset($object['business_master_id']) ? null : $object['business_master_id'];
        ...
        if (isset($userName) && isset($userLastName) && isset($userDocumentId)) {
            try {
                ...
                if ($userByDocumentID->count() < 1) {
                    ...
                    if (isset($userBusinessMasterID)) {
                        $newUser->business_master_id = $userBusinessMasterID;
                    }
                    if (isset($userPhoto)) {
