...
class AndroidPushController extends AppController
{
    ...
    private $authHeader = SERVER_KEY_API_ACCESS_KEY;

    /**
     * Header to be send to the server
     * @var array Header to be send to the server
     */
   public static $httpAndroidPushHeader = array('Authorization: key=', 'Content-Type: application/json');
    ...
    {
        self::$httpAndroidPushHeader[0] = self::$httpAndroidPushHeader[0] .SERVER_KEY_API_ACCESS_KEY;
        $httpCall = curl_init();
